                ...
                <div>
                    ...
                    <div class="custom-radios">
                        @if(count($product->colors) > 0)
                            @foreach($product->colors as $color)
                                <div>
                                    <input type="radio" id="color-{{$color->name}}" name="color" value="{{$color->id}}" onChange="setColor(this);">
                    ...
                    <div class="radio-toolbar">
                        @foreach($product->sizes as $size)
                            <input type="radio" id="radio-{{$size->name}}" name="size" value="{{$size->id}}" onChange="setSize();" style="display: none">
